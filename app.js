...
let userInput =[];
let originalStory = `In ${userInput[0]}, computer pioneer ${userInput[01]} found herself working on a ${userInput[2]}.
Word got out that the ${userInput[3]} had "debugged" the Entire ${userInput[4]}`;
